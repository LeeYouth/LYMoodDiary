...
@interface LYCustomTextView () <UITextViewDelegate>
{
    BOOL _isDeleting;
}
@property (assign, nonatomic) BOOL        isEditting;
@property (assign, nonatomic) BOOL        hideView;
@property (retain, nonatomic) LTextView   *textView;
...
@implementation LYCustomTextView
...
{
    LTextView *textView = [[LTextView alloc] initWithFrame:frame];
