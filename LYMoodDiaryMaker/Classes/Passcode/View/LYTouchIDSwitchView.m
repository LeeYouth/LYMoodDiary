...
@implementation LYTouchIDSwitchView
...
- (void)_initialize
{
    ...
    self.messageLabel.text = LY_LocalizedString(@"kLYDoYouWantTouchID");
    self.messageLabel.font = [UIFont preferredFontForTextStyle:UIFontTextStyleHeadline];
    [self addSubview:self.messageLabel];
    
    self.titleLabel = [[UILabel alloc] init];
    self.titleLabel.text = LY_LocalizedString(@"kLYCantUserTouchID");
    ...
    [self.doneButton setTitle:LY_LocalizedString(@"kLYButtonEnsureTitle") forState:UIControlStateNormal];
